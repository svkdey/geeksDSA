...
/**
 * the topological sort on directed graph say .1st parent will be visited
 * .then their any of child will be doing the visited/
 *
...
public class TopologocalSort {
    ...
    //a vertex can be push inside stack if all its dependent are in  pushed into stack
...
//        }
    ...
    public static void DFSforTopologicalSort(int v,Stack<Integer> stack,ArrayList<ArrayList<Integer>> adjList, HashSet<Integer> visited){
        visited.add(v);
...
//        return stack;
    ...
    public static void main(String[] args) {
        ...
        tropoLogicalSortByDFS(graph.adjList, graph.adjList.size());
        System.out.println();
