...
public class MaxExcludingOneELement {
...
// backward array 
		...
		/*
		 * Initializing final ans by max_so_far so that, case when no element is removed
		 * to get max sum subarray is also handled
		 */
